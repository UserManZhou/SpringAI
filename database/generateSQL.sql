...
DROP TABLE
    IF EXISTS `course_reservation`;
CREATE TABLE
    IF NOT EXISTS `course_reservation` (
                                           `id` INT NOT NULL AUTO_INCREMENT,
                                           `course` VARCHAR (50) CHARACTER
    SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '预约课程',
    `student_name` VARCHAR (255) CHARACTER
    SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '学生姓名',
    `contact_info` VARCHAR (255) CHARACTER
    SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '联系方式',
    `school` VARCHAR (50) CHARACTER
    SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '预约校区',
    `remark` TEXT CHARACTER
    SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '备注',
    PRIMARY KEY (`id`)
